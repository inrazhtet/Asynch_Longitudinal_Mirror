...
In this section, the BMI trajectory is visualized using the raw non-imputed data set generated from file **01a\_Linear\_Interpolation** of this project. There are **X** steps to achieve the trajectory visualization.
...
``` r
plot(density(baseline_6months$Media,  na.rm = TRUE),main = "Media Distribution at 6 months")
```
...
##### Importing Final Raw Data Set for Trajectory Plot
...
##### Importing the matrix data set back
