...
#### LOESS application of 1 month interval at each time cut point
...
#### Generating Raw Dataset to plot zBMI trajectories
...
In the graphical report from Belle Lab, the month intervals are segemented at 6, 13.5, 21, 28.5 and 36 months. With an average interval of at least 6 months between each time period, we are going to have an interval of 6 months with the above listed cut off months at its center.
...
-   Out of the 520 subjectIDs, how many has the non-NA values for Media exposure at 6 months?
...
Need to collapse time months onto 13.5, 21, 28.5 and 36 months using a six months interval centered around those months
...
Subsetting the data to only the time points at 6, 13.5, 21, 28.5 and 36 months
