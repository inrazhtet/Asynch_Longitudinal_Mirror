...
Saving the 5 x 5, Media Exposure categories and Year(Month) data set
```{r}
write.csv(baseline_cat_months, "../../data/final/baseline_media_months.csv")
```


- Use tapplys on both the time intervals and media categories of each subject ID to to create a 5 by 5 matrix
