...
In the graphical report from Belle Lab, the month intervals are segemented at 6, 13.5, 21, 28.5 and 36 months.
With an average interval of at least 6 months between each time period, we are going to collapse the raw data months centered at the above periods by 3 months each way. 
...
* Out of the 520 subjectIDs, how many has the non-NA values for Media exposure at 6 months? <br />
