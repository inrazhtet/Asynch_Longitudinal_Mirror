...
print(quantile(base_alltime$zBMI))
```
...
base6_l1 <- base_6[base_6$Media >=0 & base_6$Media <1, ]
#base6_l2 <- base_6[base_6$Media >=1 & base_6$Media <2, ]
base6_l3 <- base_6[base_6$Media >=2 & base_6$Media <3, ]
base6_l4 <- base_6[base_6$Media >=3 & base_6$Media <4, ]
...
plot(x, y, type = "n", main = "5 Bucket BMI Traj")
