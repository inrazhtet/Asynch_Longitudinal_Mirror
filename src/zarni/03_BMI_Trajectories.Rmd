...
#FIX STUFFS HERE! No Square Transform!
...
```{r}
#Daphna's suggestion on minutes
labels <- c("0hrs", "1hrs", "2hrs", "3hrs")
baseline_6months$MediaCategory <- cut(baseline_6months$Media, breaks = c(0,60,120,180,240), labels = labels, include.lowest = TRUE, right = FALSE) #include.lowest, True to be inclusive of left hand-side and exclusive of right hand side.
```
