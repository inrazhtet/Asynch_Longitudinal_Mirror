...
The objective of this section is to temporarily remove the data set portion of bullet point 1 above and permanently remove the case for bullet point 4. The other 2 cases will handle itself through our Linear Interpolation function.
...
dim(p_bmi)
#This is the Singleton File of BMI 
p_bmi_singleton <- p_bmi[(p_bmi$ID_ %in% bmi_exclude$ID_),]
write.csv(p_bmi_singleton, "../../data/processing/bmi_subject_singleton.csv")
```
...
#This is the media Singleton Output
p_media_singleton <- p_media[(p_media$ID_ %in% media_exclude$ID_),]
write.csv(p_media_singleton, "../../data/processing/media_subject_singleton.csv")
...
**[UPDATE_1]** This matching issue has been handled in 01_Addendum.Rmd file.
...
write.csv(c_data_arr_mer, "../../data/final/merged_arranged_data.csv")
```
