...
c_data_interp <- lapply(c_data_split, mdz_interpolate, par=c(2,3))
...
mdz_interpolate <- function(df, par){
  ...
  #Specifying indexes where we had to fill with the missing NA
...
This helper function puts the two variables into the same data frame
...
#test_put_together <- d_replace(test_1,test_output, 3)
